...
/**
 * <p>Classe Java pour ConsulterIndividuParNirEtNomDeNaissanceResponse complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="idMetier" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "ConsulterIndividuParNirEtNomDeNaissanceResponse", propOrder = {
    "idMetier",
    "nomDeNaissance",
    "prenom",
    "civilite",
...
public class ConsulterIndividuParNirEtNomDeNaissanceResponse {

    @XmlElement(required = true)
    protected String idMetier;
    @XmlElement(required = true)
    ...
    /**
     * Obtient la valeur de la propriété idMetier.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété idMetier.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIdMetier(String value) {
        this.idMetier = value;
    }
